    ...
    mainNavStack() {
        return (
            <Stack.Navigator>
                ...
                <Stack.Screen
                    name="WelcomeUS"
                    component={Welcome1USScreen}
                    options={{ headerShown: false }}
                />
                <Stack.Screen
                    name="Welcome2US"
                    component={Welcome2USScreen}
                    options={{ headerShown: false }}
                />
                <Stack.Screen
                    name="WelcomeRepeat"
                ...
                />
                <Stack.Screen
                    name="WelcomeRepeatUS"
                    component={WelcomeRepeatUSScreen}
                    options={{ headerShown: false }}
                />
                <Stack.Screen
                    name="Consent"
                ...
                />
                <Stack.Screen
                    name="BeforeWeStartUS"
                    component={BeforeWeStartUS}
                    options={{ headerShown: false }}
                />
                <Stack.Screen
                    name="ResetPassword"
                ...
                <Stack.Screen
                    name="OptionalInfo"
                    component={OptionalInfoScreen}
                    options={{ headerShown: false }}
                />
                <Stack.Screen
                    name="StartPatient"
                    component={StartPatientScreen}
                    options={{ headerShown: false }}
                />
                <Stack.Screen
                    name="YourStudy"
                    component={YourStudyScreen}
                    options={{ headerShown: false }}
                />
                <Stack.Screen
                    name="YourWork"
                ...
                <Stack.Screen
                    ...
                    component={PreviousExposureScreen}
                    options={{ headerShown: false }}
                />
                <Stack.Screen
                ...
                <Stack.Screen
                    name="HowYouFeel"
                    component={HowYouFeelScreen}
                    options={{ headerShown: false }}
                />
                <Stack.Screen
                    name="DescribeSymptoms"
                    component={DescribeSymptomsScreen}
                    options={{ headerShown: false }}
                />
                <Stack.Screen
                    name="WhereAreYou"
                ...
                <Stack.Screen
                    ...
                    component={LevelOfIsolationScreen}
                    options={{ headerShown: false }}
                />
                <Stack.Screen
                ...
                <Stack.Screen
                    name="TreatmentOther"
                    component={TreatmentOtherScreen}
                    options={{ headerShown: false }}
                />
                <Stack.Screen
                    name="ThankYou"
                ...
                />
                <Stack.Screen
                    name="ConsentForOther"
                    component={ConsentForOther}
                    options={{ headerShown: false }}
                />
                <Stack.Screen
                    name="ReportForOther"
                    component={ReportForOtherScreen}
                    options={{ headerShown: false }}
                />
                <Stack.Screen
                    name="SelectProfile"
