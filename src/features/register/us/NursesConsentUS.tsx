        ...
        return (
            ...
            <View style={styles.rootContainer}>
                <ScrollView>
                    ...
                    <RegularText>This research consent form has been approved by the Institutional Review Board at Massachusetts General Hospital (Partners Human Research Committee Protocol #2020P000909 Version Date: 3/31/2020){"\n"}</RegularText>
                    ...
                    <RegularText>
                        We are doing this research to determine health and lifestyle factors related to the symptoms and outcomes associated with the Coronavirus (COVID-19). By using this app that consists of a series of questions meant to collect data on whether you are well or have symptoms, you
                        will be helping medical science and healthcare providers across the country to better understand this disease. This app is designed to be a tool for data collection and to help medical professionals and researchers understand this disease. It does not give health advice. The
                        Centers for Disease Control and Prevention has publicly-accessible information related to COVID-19 that can be found at: <ClickableText
                        onPress={() => this.openUrl('https://www.cdc.gov/coronavirus/2019-ncov/index.html')}>https://www.cdc.gov/coronavirus/2019-ncov/index.html</ClickableText>.
                        {"\n"}
                    </RegularText>

                    <RegularBoldText>How long will I take part in this research study?{"\n"}</RegularBoldText>
                    <RegularText>
                        Your use of this mobile application is completely voluntary. You can use it as little or as much as you would like and can stop using it at any time. We find that answering the series of questions takes a matter of minutes (no more than 10 minutes on average).
                        {"\n"}
                    </RegularText>
                    ...
                    <RegularText>
                        We will ask you a series of questions related to your occupation, your possible affiliation with certain ongoing studies or research centers, basic personal characteristics (gender/age), your health status, any medications you are using, how you are feeling, what symptoms you
                        might be experiencing, and what, if any, treatments you’ve received either in outpatient or in-hospital settings. We will also ask you about what the outcome of any of those treatments. All questions are optional and you need not answer any questions you are uncomfortable
                        answering.
                        {"\n"}
                    </RegularText>

                    <RegularBoldText>What are the risks and possible discomforts from being in this research study?{"\n"}</RegularBoldText>

                    <RegularText>
                        We don’t expect you to experience any risks or possible discomforts associated with being in this study. Some people may not feel comfortable answering some of the questions asked, but no question is required to be answered. While necessary security precautions have been
                        taken, there is a minor risk as there is with all digital data that information shared with us may be inadvertently accessed by others not identified in this consent form.
                        {"\n"}
                    </RegularText>

                    <RegularBoldText>What are the possible benefits from being in this research study?{"\n"}</RegularBoldText>
                    <RegularText>
                        There are no direct benefits to you for taking part in this study. Your participation may contribute more widely, with all the other participants to the advancement of research into the COVID virus.
                        {"\n"}
                    </RegularText>

                    <RegularBoldText>Can I still get medical care within hospitals affiliated with the research in this study, or if I stop taking part?{"\n"}</RegularBoldText>
                    <RegularText>
                        Yes. Your decision won’t change the medical care you get within affiliated hospitals now or in the future. There will be no penalty, and you won’t lose any benefits you receive now or have a right to receive.
                        Taking part in this research study is up to you. You can decide not to take part. If you decide to take part now, you can change your mind and drop out later.
                        {"\n"}
                    </RegularText>
                    ...
                    <RegularText>
                        ...
                        {"\n"}{"\n"}
                        If you were directed to this app because of your participation in another research study, you should contact the applicable study contact or Institutional Review Board that is associated with each study. If the study is affiliated with Mass General Brigham Health / Partners
                        Healthcare, please contact the Partners Human Research Committee office. You can call them at 857-282-1900.
                        {"\n"}
                    </RegularText>

                    <RegularBoldText>If I take part in this research study, how will you protect my privacy?{"\n"}</RegularBoldText>
                    <RegularText>
                        During this research, identifiable information about your health will be collected. In the rest of this section, we refer to this information simply as “health information”. In general, under federal law, health information is private. However, there are exceptions to this
                        rule, and you should know who may be able to see, use, and share your health information for research and why they may need to do so.
                        {"\n"}
                    </RegularText>
                    ...
                    <RegularText>
                        ...
                        {"\n"}{"\n"}
                        Some people or groups who get your health information might use or share your health information without your permission in ways that are not described in this form. We share your health information only as provided in this consent form, and we ask anyone who receives it from
                        us to take measures to protect your privacy.
                        {"\n"}{"\n"}
                        ...
                        {"\n"}{"\n"}
                        We may link data collected as a part of this app with additional data collected through your participation in other research studies you have consented to at the following institutions: Massachusetts General Hospital, Brigham and Women’s Hospital, Mass General Brigham
                        Hospitals (formerly Partners Healthcare), or other partnering research institutions. Deidentified data, meaning that any information that can identify you as an individual has been removed, may be included in public databases in the future.
                        {"\n"}
                    </RegularText>
                    ...
                    <RegularText>
                        ...
                        {"\n"}{"\n"}
                        In addition, you acknowledge that you have read and understand the Privacy Policy and Terms of Use. The privacy policy describes what data is collected, how it is stored, secured, and shared, and with whom, and what your rights are to that data. The terms state that that the
                        application is not meant to give medical advice, is not meant for emergencies and is not a medical device, and describes limitations of liability and data sharing plans.
                        {"\n"}
                    </RegularText>
