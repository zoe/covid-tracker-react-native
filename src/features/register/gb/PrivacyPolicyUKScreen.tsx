      ...
      <View style={styles.rootContainer}>
        <ScrollView>
          ...
          <RegularText>
            ...
            <ClickableText
              onPress={() =>
                openExternalLink('http://eur-lex.europa.eu/legal-content/EN/TXT/PDF/?uri=CELEX:32016R0679&from=EN')
              }>
              GDPR
            </ClickableText>{' '}
            ...
            be contacted at{' '}
            <ClickableText onPress={() => openExternalLink('https://ico.org.uk/make-a-complaint/')}>
