            ...
            <View style={styles.rootContainer}>
                <ScrollView>
                    ...
                    <RegularText>
                        ...
                        {"\n\n"}
                        Our legal basis for processing it is that you consented to our doing so. Because of the tight regulatory requirements placed on us, we need your consent to process data about your health, which means that if you do not consent (or withdraw your consent), we cannot allow you
                        to use the app. This is not meant unkindly, we are simply not able to provide you with the service without your consent.
                        {"\n\n"}
                    ...
                    <RegularText>
                        ...
                        instructions and to take proper care in using it. They are not permitted to keep the data after our relationship with them has ended.
                        {"\n\n"}
                    ...
                    <RegularText>
                        Under the {" "}
                        <ClickableText onPress={() => this.openUrl('http://eur-lex.europa.eu/legal-content/EN/TXT/PDF/?uri=CELEX:32016R0679&from=EN')}>GDPR</ClickableText> {" "}
                        ...
                        <ClickableText onPress={() => this.openUrl('https://ico.org.uk/for-organisations/guide-to-data-protection/guide-to-the-general-data-protection-regulation-gdpr/individual-rights/')}>
                            Guidance from the United Kingdom Information Commissioner’s Office (ICO) on individuals rights under the General Data Protection Regulation.
                        </ClickableText>
                        ...
                        {"\n\n"}
                        The {" "}
                        <ClickableText onPress={() => this.openUrl('http://eur-lex.europa.eu/legal-content/EN/TXT/PDF/?uri=CELEX:32016R0679&from=EN')}>General Data Protection Regulation</ClickableText> {" "}
                        also gives you the right to lodge a complaint with a supervisory authority, in particular in the European Union (or European Economic Area) state where you work, normally live or where any alleged infringement of data protection laws occurred. The supervisory authority in the
