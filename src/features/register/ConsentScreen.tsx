  ...
  renderSwedishConsent = () => {
    return (
      <ScrollView>
        ...
        />
        <RegularText>
          All information som samlas in från användarna av appen Covid-19 Symptom Tracker kommer att sammanställas och
        ...
        <RegularText>
          ...
          <RegularBoldText>leavecovidtracking@joinzoe.com</RegularBoldText> från den e-postadress du använt för att
