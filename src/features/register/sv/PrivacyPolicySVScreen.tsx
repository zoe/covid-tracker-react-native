...
export default class PrivacyPolicySVScreen extends Component<PropsType, {}> {
    ...
    render() {
        return (
            <View style={styles.rootContainer}>
                <ScrollView>
                    <RegularText>Denna app har skapats och drivs av Zoe Global Limited (”Zoe”), som är ett hälsoteknikföretag. Zoe har tillgång till den information du anger.</RegularText>
                    ...
                    <RegularText>
                        På grund av typen av forskning som vi genomför kan vi inte ange en specifik tidsgräns för lagringen av känsliga personuppgifter, men vi granskar detta regelbundet och säkerställer att de inte sparas längre än nödvändigt. Om du vill att vi ska sluta behandla dina känsliga personuppgifter kan du dra tillbaka ditt medgivande när som helst genom att skicka ett e-postmeddelande till <RegularBoldText>leavecovidtracking-sweden@joinzoe.com</RegularBoldText>. När du drar tillbaka ditt medgivande raderar vi alla känsliga personuppgifter som vi har om dig.
                    </RegularText>

                    <HeaderText text={"Dataskyddsförordningen (GDPR)"}/>
                    <SimpleTextBlock text={[
                        "Vi behandlar också dina kontaktuppgifter i syfte att:",
                    ]} />
                    <BulletedTextBlock text={[
                    ...
                    <RegularText>
                        I enlighet med {" "}
                        <ClickableText onPress={() => this.openUrl('https://eur-lex.europa.eu/legal-content/SV/TXT/PDF/?uri=CELEX:32016R0679&rid=1')}>GDPR</ClickableText> {" "}
                        ...
                        <ClickableText onPress={() => this.openUrl('https://ico.org.uk/for-organisations/guide-to-data-protection/guide-to-the-general-data-protection-regulation-gdpr/individual-rights/')}>
                        ...
                        {"\n\n"}
                        Om du vill utöva någon rätt ber vi dig skicka en e-post, ringa eller skriva till vår dataskyddsansvarige med hjälp av kontaktuppgifterna nedan.
                        {"\n\n"}
                        Enligt {" "}
                        <ClickableText onPress={() => this.openUrl('https://eur-lex.europa.eu/legal-content/SV/TXT/PDF/?uri=CELEX:32016R0679&rid=1')}>GDPR</ClickableText> {" "}
                        har du även rätt att lämna in ett klagomål till en tillsynsmyndighet, företrädesvis i den medlemsstat inom den Europeiska unionen (eller det Europeiska ekonomiska samarbetsområdet) där du arbetar, vanligtvis bor eller där eventuell påstådd överträdelse av dataskyddslagen inträffat. Tillsynsmyndigheten i Storbritannien är Information Commissioner som kan kontaktas på {" "}
                        <ClickableText onPress={() => this.openUrl('https://ico.org.uk/make-a-complaint/your-personal-information-concerns')}>
