...
import { blog018, blog019, blog020, dataPage003, notificationReminders, timUpdate017 } from '@assets';
        ...
        <SafeAreaView>
          <ScrollView contentContainerStyle={styles.scrollView}>
            <View style={styles.rootContainer}>
              ...
              <ExternalCallout
                link="https://covid.joinzoe.com/post/covid-school-communities?utm_source=App"
                calloutID="blog_020"
                imageSource={blog020}
                aspectRatio={1.555}
                screenName={this.props.route.name}
              ...
              <ExternalCallout
                link="https://youtu.be/H7O1U-ZSR0w"
                calloutID="tim_update_017"
                imageSource={timUpdate017}
                aspectRatio={1.0}
                screenName={this.props.route.name}
              />
