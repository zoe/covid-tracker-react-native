...
export default function QuoteMarks(props: IProps) {
  return (
    <Svg height="22px" style={props.style} viewBox="0 0 24 22" width="24px">
      <G
        fill="none"
        fillRule="evenodd"
        id="Page-1"
        ...
        strokeWidth="1.5"
      >
        <G id="Group" stroke={props.color ?? colors.accentBlue.main.bgColor} transform="translate(0.000000, 1.000000)">
          <Path
